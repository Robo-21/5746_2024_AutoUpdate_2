...
public class FourNote_rightfirst extends SequentialCommandGroup {
   ...
   */
  public FourNote_rightfirst(Launcher launcher, Intake intake, Drivetrain drivetrain, WristIntake wristintake) {
    m_launcher = launcher;
    m_intake = intake;
    m_drivetrain = drivetrain;
    m_wristintake = wristintake;
    // Use addRequirements() here to declare subsystem dependencies.
    addRequirements(launcher, intake, drivetrain, wristintake);
